...
<body>
			...
			<div class="row" style="padding-top: 15px; padding-bottom: 15px">
				<div class="col-lg-12">
					<button type="button" class="btn btn-success btn-default"
						data-toggle="modal" data-target="#addUserModal" id="showAddBtn">添加用户</button>
					<button type="button" class="btn btn-warning btn-default"
						data-toggle="modal" data-target="#editUserModal" id="showEditBtn">修改用户</button>
					<button type="button" class="btn btn-danger btn-default" id="deleteBtn">删除用户</button>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form role="form" id="addUserForm">
						...
						<div class="form-group">
							<label>微信号</label> <input type="text" class="form-control"
								name="wechat">
						...
						<div class="form-group">
							<label>等级</label> <select class="form-control" name="level">
	...
	<!-- 修改用户 -->
	<div class="modal fade" data-backdrop="static" id="editUserModal"
		tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
		aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form role="form" id="editUserForm">
						...
						<div class="form-group">
							<label>手机号</label> <input class="form-control" name="cellphone">
							<p class="help-block">这里填写用户的手机号</p>
						</div>
						<div class="form-group">
							<label>微信号</label> <input class="form-control" name="wechat">
							<p class="help-block">这里填写用户的微信号</p>
						</div>
						<div class="form-group">
							<label>地址</label>
